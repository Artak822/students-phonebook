...
При начале каждого этапа фронтенда вызывать:
...
И передать:
1. **Какой экран** (название страницы, URL)
...
5. **Стек**: Next.js 14 App Router, TypeScript, TanStack Query, React Hook Form + Zod, react-imask
